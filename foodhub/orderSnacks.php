        ...
        <div class="card card-body">
            <div class="row">
                <div class="d-flex">
                    ...
                    <a href="<?php echo $_SERVER['PHP_SELF']; ?>" style="width: 26vw;" class="btn btn-success mx-2">Snacks Menu</a>
                    <a href="orderRegular.php" style="width: 26vw;" class="btn btn-success mx-2">Regular Menu</a>
                </div>
            </div>
        </div>
    </div>
